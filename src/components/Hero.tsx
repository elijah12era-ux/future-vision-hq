...
const Hero = () => {
  return (
    <section id="home" className="relative overflow-hidden">
      ...
      <HeroGeometric
        badge="Futuristic International"
        title1="Engineering the Future"
        title2="of Construction & MEP"
        className="min-h-[600px] md:min-h-screen flex items-center"
      />
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <Button
                size="lg"
                className="button-gradient text-primary-foreground font-bold text-base md:text-lg px-8 py-6 hover:shadow-2xl transition-all group w-full sm:w-auto"
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white text-white bg-white/10 backdrop-blur-sm hover:bg-white hover:text-primary font-bold text-base md:text-lg px-8 py-6 w-full sm:w-auto"
