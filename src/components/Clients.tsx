    ...
    <section id="clients" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {[
            { icon: Shield, label: isRTL ? "معتمد من NFPA" : "NFPA Certified" },
            { icon: Award, label: "ISO 9001:2015" },
            { icon: Target, label: isRTL ? "الامتثال لـ QHSE" : "QHSE Compliance" },
            { icon: Users, label: isRTL ? "محترفون مدربون" : "Trained Professionals" },
          ].map((cert, index) => (
            <div
              key={cert.label}
